...
const helpContent = {
	shellType: {
		...
		body: 'Chọn loại pháo hoa bạn muốn bắn. Hãy chọn "Random" để có trải nghiệm tuyệt vời!'
	},
	shellSize: {
	...
	quality: {
		...
		body: 'Nếu hoạt ảnh chạy không mượt, bạn có thể thử giảm chất lượng. Chất lượng càng cao thì càng có nhiều tia lửa sau khi pháo hoa nở, nhưng chất lượng cao có thể khiến thiết bị của bạn bị đơ.'
	},
	skyLighting: {
	...
	autoLaunch: {
		header: 'Pháo hoa tự động',
		body: 'Sau khi bật, bạn có thể ngồi trước màn hình thiết bị của mình và thưởng thức pháo hoa. Sau khi tắt, bạn chỉ có thể bắn pháo hoa bằng cách nhấp vào màn hình.'
	},
	finaleMode: {
		header: 'Nhiều Pháo hoa cùng lúc',
		body: 'Nhiều pháo hoa có thể được bắn tự động cùng lúc (nhưng bạn cần bật "Pháo hoa tự động" trước).'
	},
	hideControls: {
	...
	longExposure: {
		header: 'Giữ Tia lửa từ Pháo hoa',
		body: 'Có thể giữ lại trên màn hình tia lửa pháo hoa để lại.'
	}
};
...
if (IS_HEADER) {
	...
	setLoadingStatus('Chuẩn bị thành công');
	setTimeout(() => {
